...
(function (w, doc, undefined) {
    var video_player_wrapper = document.querySelector("[data-video-player]"),
        video_container = document.querySelector(
            "[data-video-player] [data-video]"
        ),
        video_player = video_container.querySelector("iframe"),
        video_playlist_container = document.querySelector(
            "[data-video-player] [data-playlist]"
        ),
        video_playlist = video_playlist_container.querySelector("ul"),
        video_playlist_items = Array.from(
            video_playlist.querySelectorAll("li")
        ),
        video_playlist_sources = Array.from(
            video_playlist.querySelectorAll("a")
        ),
        video_id = util.generateID("c__video-player-");
    ...
    var tabKeyboardRespond = function (e, tab) {
        var nextTab = tab.parentNode.nextElementSibling
                ? tab.parentNode.nextElementSibling.querySelector(
                      "[role='tab']"
                  )
                : false,
            previousTab = tab.parentNode.previousElementSibling
                ? tab.parentNode.previousElementSibling.querySelector(
                      "[role='tab']"
                  )
                : false,
